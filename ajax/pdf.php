...
//        $html .= "<br>Av. Volcán Lascar N°818, Parque industrial Lo Boza";
//        $html .= "<br>RUT: 85.233.500-9";
//        $html .= "<br>Teléfono Mesa Central: 229493900";
//        $html .= "<br>Teléfono Emergencias: 229493935";
//        $html .= "<br>Pudahuel, Santiago - Chile";
//        $html .= "<p align=right>Fecha: ". $resp['ini'] ."</p>";
//        $html .= "<h1 align=center>Guía de servicio N° " . $resp['idservicio'] . "</h1>";
//        $html .= "";
//        $html .= "<table border=1>";
//        $html .= "<tr>";
//        $html .= "<td width=240px>Segmento</td>";
//        $html .= "<td width=440px>". $resp['segmen'] ."</td>";
//        $html .= "</tr>";
//        $html .= "<tr>";
//        $html .= "<td width=240px>Edificio</td>";
//        $html .= "<td width=440px>". $resp['edi'] ."</td>";
//        $html .= "</tr>";
//        $html .= "<tr>";
//        $html .= "<td width=240px>Dirección</td>";
//        $html .= "<td width=440px>". $resp['calle'] ." ". $resp['numero'] ."</td>";
//        $html .= "</tr>";
//        $html .= "<tr>";
//        $html .= "<td width=240px>Region</td>";
//        $html .= "<td width=440px>". $resp["region"] ."</td>";
//        $html .= "</tr>";
//        $html .= "<tr>";
//        $html .= "<td width=240px>Comuna</td>";
//        $html .= "<td width=440px>". $resp["comuna"] ."</td>";
//        $html .= "</tr>";
//        $html .= "<tr>";
//        $html .= "<td width=240px>Equipo</td>";
//        $html .= "<td width=440px>". $resp["marca"] ." ". $resp["modelo"] ."</td>";
//        $html .= "</tr>";
//        $html .= "<tr>";
//        $html .= "<td width=240px>Tipo</td>";
//        $html .= "<td width=440px>". $resp["tascen"] ."</td>";
//        $html .= "</tr>";
//        $html .= "<tr>";
//        $html .= "<td width=240px>Codigo FM</td>";
//        $html .= "<td width=440px>". $resp["codigo"] ."</td>";
//        $html .= "</tr>";
//        $html .= "<tr>";
//        $html .= "<td width=240px>Tecnico</td>";
//        $html .= "<td width=440px>". $resp["nomtec"] ." ". $resp["apetec"] ."</td>";
//        $html .= "</tr>";
//        $html .= "<tr>";
//        $html .= "<td width=240px>RUT</td>";
//        $html .= "<td width=440px>". $resp["ruttec"] ."</td>";
//        $html .= "</tr>";
//        $html .= "<tr>";
//        $html .= "<td width=240px>Cargo</td>";
//        $html .= "<td width=440px>". $resp["cartec"] ."</td>";
//        $html .= "</tr>";
//        $html .= "<tr>";
//        $html .= "<td width=240px>Tipo de Servicio</td>";
//        $html .= "<td width=440px>". $resp["tser"] ."</td>";
//        $html .= "</tr>";
//        $html .= "<tr>";
//        $html .= "<td width=240px>Fecha y Hora de Inicio</td>";
//        $html .= "<td width=440px>". $resp["ini"] ."</td>";
//        $html .= "</tr>";
//        $html .= "</table>";
//        $html .= "<br>";
//        $html .= "<br>";
//        $html .= "<br>";
//        $html .= "____________________________________________________________________________________________ ";
//        $html .= "<table><tr><td  width=680px align=center>Fabrimetal. Todos los derechos reservados</td></tr></table>";
...
<body>
    <div class="invoice-box">
        <table cellpadding="0" cellspacing="0">
            ...
            <tr class="item">
                <td>
                    <b>FECHA Y HORA DE INICIO: </b> ' . $resp["ini"] . '
                </td>
            </tr>
        ...
        $guiaPDF->WriteHTML($body);
        $archivo = round(microtime(true)) . ".pdf";
        $guiaPDF->Output('/var/www/html/gservicio/files/pdf/' . $archivo, 'F');
        break;
}
?>