        ...
        case  'finalizarsap':
            ...
            if($tiposervicio == 'Mantención' || $tiposervicio == 'Mantenci\u00f3n' || $tiposervicio == 'MantenciÃ³n'){
                    ...
                    if ($porfirmar != "true"){
                        break;
                        $logFile = fopen("../log.txt", 'a') or die("Error creando archivo");
                        fwrite($logFile, "\n".date("d/m/Y H:i:s")." - Ha salido para firmar despues") or die("Error escribiendo en el archivo");
                        fclose($logFile);
                    }
                    ...
                    if($rspta == 1 || $rspta === 1 || $rspta == "1"){
                        ...
                        //comentario_prueba if(!empty($datosactividad['value'][0]['equSupEmail'])){
                        //comentario_prueba     $Mailer->addAddress($datosactividad['value'][0]['equSupEmail'], '');
                        //comentario_prueba }
                        
                        //agrega cuando sea Ingenieria de Campo
                        //comentario_prueba if($datosactividad['value'][0]['srvTipoLlamadaId'] == 16){
                        //comentario_prueba     $Mailer->addAddress('finostroza@fabrimetal.cl','');
                        //comentario_prueba     $Mailer->addAddress('igalvez@fabrimetal.cl','');
                        //comentario_prueba }
                        
                        // agrega cuando sea Reparaciones
                        //comentario_prueba if($datosactividad['value'][0]['srvTipoLlamadaId'] == 2){
                        //comentario_prueba     $Mailer->addAddress('mmonares@fabrimetal.cl','');
                        //comentario_prueba     $Mailer->addAddress('paraneda@fabrimetal.cl','');
                        //comentario_prueba }
                        
                        
                        //contactos del cliente
                        //comentario_prueba $select = 'ContactEmployees';
                        //comentario_prueba $entity = "BusinessPartners";
                        //comentario_prueba $id = $datosactividad['value'][0]['cliCodigo'];
                        //comentario_prueba $contactos = json_decode(ConsultaIDLet($entity,$id,$select),true);
                        //comentario_prueba if(count($contactos['ContactEmployees']) > 0){
                        //comentario_prueba     foreach($contactos['ContactEmployees']  as $key => $val){
                        //comentario_prueba         if(!empty($val['E_Mail']) && $val['EmailGroupCode'] == 'GSE'){
                        //comentario_prueba             $Mailer->addAddress($val['E_Mail'], $val['FirstName'].' '.$val['LastName']);
                        //comentario_prueba         }
                        //comentario_prueba     }
                        //comentario_prueba }
                        ...
                        if ($_POST["oppre"] == "1"){
                            ...
                            //comentario_prueba $Mailer->addAddress('dmediavilla@fabrimetal.cl');
                            ...
                            //comentario_prueba if($_SESSION['subcontrato'] == 1){
                            //comentario_prueba     $Mailer->addCC('fanny@remant.cl');
                            //comentario_prueba     $Mailer->addCC('dario@remant.cl');
                            //comentario_prueba }
                ...
                if($opfirma=='1' || $opfirma=='3'){
                    ...
                    if($datosactividad['value'][0]['srvTipoLlamadaId'] == 16){
                        //comentario_prueba $Mailer->addAddress('upino@fabrimetal.cl','');
                    }
                ...
                if($opfirma=='2' || $opfirma == 2){
                    ...
                    //comentario_prueba $Mailer->addAddress('vvasquez@fabrimetal.cl');
                    $Mailer->addAddress('jaguilera@fabrimetalsa.cl');
                    $Mailer->addAddress('vvasquez@fabrimetal.cl');
        ...
        case 'firmapendiente':
            ...
            if($llamada != 'Mantención'){
                ...
                if(!isset($_SESSION['correo_enviado'])){
                    ...
                    //comentario_prueba $Mailer->addAddress('aramirez@fabrimetalsa.cl');
