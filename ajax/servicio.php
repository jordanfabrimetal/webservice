...
switch ($_GET["op"]) {
    ...
    case 'finalizar':
        ...
        ';
            ...
            $Mailer->Password = "20f4Br1#818M3t4L$173024";
    ...
    case  'finalizarsap':
        ...
        if ($tiposervicio == 'Mantención' || $tiposervicio == 'Mantenci\u00f3n' || $tiposervicio == 'MantenciÃ³n') {
            ...
            $params['estadoascensor'] = $_POST['estadoascensor'];
            ...
            if ($opfirma == '1' || $opfirma == '3') {
                ...
                $bodypdf .= '<tr class="item">
                                        ...
                                        <tr class="item">
                                            <td>
                                                <b>ESTADO DEL EQUIPO AL INICIAR: </b> ' . ($datosactividad['value'][0]['actEstEquiIni'] == 01 || $datosactividad['value'][0]['actEstEquiIni'] == "01" ? 'OPERATIVO' : 'DETENIDO') . '
                                            </td>
                                        </tr>
                                        <tr class="item">
                                            <td>
    ...
    case 'firmarsap':
        ...
        if ($_POST['firmavali'] == 'Firma validada') {
            ...
            $Mailer->addAddress($_SESSION['jaguilera@fabrimetalsa.cl']);
