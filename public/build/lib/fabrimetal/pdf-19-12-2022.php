...
function newPdf($opcion, $data = '', $output = 'browser', $params = array()) {
	...
	switch ($opcion) {
        ...
        case 'informemantencionnuevo': //gservicio
            ...
            $t->newBlock('cliente');
            $t->assign('edificio',$params['actividadsap']['equEdificio']);
            ...
            $t->assign('nombrecontacto',$params['actividadsap']['cliNombre']);
            $t->assign('telefonocontacto','987654321');
            ...
            $t->assign('maniobra','maniobra');
            $t->assign('comando',$params['actividadsap']['artComando']);
            $t->assign('sm','sm');
            $t->assign('accionamiento','accionamiento');
            ...
            switch(strlen($params['actividadsap']['actHoraIni'])){case 1: $horaInicio = '000'.$horaInicio; break;case 2: $horaInicio = '00'.$horaInicio; break;case 3: $horaInicio = '0'.$horaInicio; break;}
            $horaInicio = date('H:i',strtotime($hora)).(($versegundos) ? ':00' : '');
            ...
            <table>
                <tr>
                    <td width=623 colspan=32 class="titulo-gris">RECEPCIÓN CONFORME MANTENIMIENTO OCTUBRE 2022 POR PARTE DEL CLIENTE </td>
                </tr>
                <tr>
